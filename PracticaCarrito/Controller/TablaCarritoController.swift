...
class TablaCarritoController: UITableViewController {
    let arrayCategoria = [
    ...
    var aregloCarrito: [Carrito] = []
    
    override func viewDidLoad() {
        super.viewDidLoad()
        
        aregloCarrito = [
            Carrito(imagen: arregloProductos[1], producto: arregloProductos[1], categoria: arregloProductos[1], precio: arregloProductos[1])
        ...
        arregloProductos = [
           ...
           Producto(imagen: "imagen5", nombre: "Producto 10", categoria: arrayCategoria[1], colores: "Verde", precio: "20000") ]        // Uncomment the following line to preserve selection between presentations
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        return aregloCarrito.count
    }

    
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "celdaCarrito", for: indexPath) as! DetalleCaritoCell
        
        let carrito = aregloCarrito[indexPath.row]
        
        //cell.imagenProducto.image = UIImage(named: carrito.producto?.imagen!)
        
        cell.lblProducto.text = carrito.producto?.nombre!
        
        cell.lblCategoria.text
        = carrito.producto?.categoria.nombre!
        
        cell.lblPrecio.text = carrito.producto?.precio! 
        // Configure the cell...
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        let indexPath = self.tableView.indexPathForSelectedRow
           let carrito = aregloCarrito[indexPath!.row]
           let dc = segue.destination as! DetalleCarritoController
           dc.carrito = carrito
